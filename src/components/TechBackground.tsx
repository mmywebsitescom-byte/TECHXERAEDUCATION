...
export default function TechBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-[#F9FAFF]">
      <div className="absolute inset-0 tech-grid opacity-[0.6]"></div>
      
      {/* Dynamic Ambient Orbs - Refined for Light Theme */}
      ...
      <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] bg-primary/5 rounded-full blur-[100px] animate-float opacity-20" style={{ animationDelay: '4s' }}></div>

      {/* Floating Geometric Subtle Shapes */}
      <div className="absolute top-[15%] right-[25%] w-24 h-24 border border-primary/10 rounded-[2rem] rotate-12 animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <svg className="absolute top-[40%] left-[5%] w-24 h-24 text-primary/10 opacity-30" viewBox="0 0 100 100" fill="currentColor">
