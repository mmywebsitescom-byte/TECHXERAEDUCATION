...
import { Code, Terminal, Database, Cpu, Zap, Globe, Cpu as Chip } from 'lucide-react'
...
export default function TechBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none bg-[#F9FAFF]">
      ...
      {/* Floating Tech Icons - Decreased size and highlighted as requested */}
      <motion.div 
      ...
      <motion.div 
        animate={{ x: [0, 20, 0], y: [0, -10, 0], opacity: [0.15, 0.3, 0.15] }}
      ...
      {/* Subtle Grid Points */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_0%,_#F9FAFF_100%)] opacity-40"></div>
    </div>
  )
}
