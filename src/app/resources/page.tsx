    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto p-6 md:p-10 space-y-10">
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row gap-4 items-center bg-white p-4 rounded-2xl shadow-sm border border-border/50"
        >
        ...
        {filtered.length === 0 && (
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center py-20 bg-white rounded-3xl border border-dashed border-border/60"
          >
