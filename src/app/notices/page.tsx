    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto p-6 md:p-10 space-y-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-2 p-3 bg-primary/10 text-primary rounded-2xl">
            <Megaphone size={20} />
        ...
        <div className="space-y-6">
          {notices.map((notice) => (
            <Card key={notice.id} className={`shadow-sm border-l-4 transition-all hover:translate-x-2 duration-300 ${notice.type === 'Urgent' ? 'border-l-destructive border-border/50 bg-destructive/[0.02]' : 'border-l-primary border-border/50'}`}>
