  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto p-6 md:p-10 space-y-10">
        {/* Profile Welcome */}
        <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between animate-in slide-in-from-top duration-700">
          ...
          <div className="flex gap-4">
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-border/50 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex flex-col items-center justify-center p-6 bg-primary text-white rounded-3xl shadow-lg shadow-primary/20 hover:scale-105 transition-transform">
                <BookOpen size={24} className="mb-2" />
                <span className="text-sm font-bold">Library</span>
              </button>
              <button className="flex flex-col items-center justify-center p-6 bg-secondary text-white rounded-3xl shadow-lg shadow-secondary/20 hover:scale-105 transition-transform">
