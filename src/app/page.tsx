...
const ReactIcon = () => (
  <svg width="48" height="48" viewBox="-11.5 -10.23174 23 20.46348" fill="none" stroke="currentColor" strokeWidth="1">
...
const techStackLogos: LogoItem[] = [
  ...
  { node: <div className="p-2 text-white font-code text-3xl font-bold">TS</div> },
  { node: <div className="p-2 text-white font-code text-3xl font-bold">JS</div> },
  { node: <div className="p-2 text-white"><NextJsIcon /></div> },
  { node: <div className="p-2 text-white"><ReactIcon /></div> },
  { node: <div className="p-2 text-white"><Zap size={40} /></div> },
  { node: <div className="p-2 text-white"><Cpu size={40} /></div> },
]
